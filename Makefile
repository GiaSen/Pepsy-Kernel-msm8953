...
HOSTCC       = gcc
HOSTCXX      = g++
HOSTCFLAGS   = -Wall -Wmissing-prototypes -Wstrict-prototypes -O3 -pipe -fomit-frame-pointer -std=gnu89
...
CFLAGS_MODULE   = -mcpu=cortex-a53
AFLAGS_MODULE   =
LDFLAGS_MODULE  =
CFLAGS_KERNEL	= -mcpu=cortex-a53
AFLAGS_KERNEL	=
